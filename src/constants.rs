...
pub mod env {
    ...
    /// Bot ID, used as a non-interactive credential source in server environments
    pub const BOT_ID: &str = "WECOM_CLI_BOT_ID";

    /// Bot Secret, used as a non-interactive credential source in server environments
    pub const BOT_SECRET: &str = "WECOM_CLI_BOT_SECRET";
